...
alert('Seja bem-vindo ao menu interativo. Vamos começar!')

let opcaoEscolhida = 0;

do {
    if (opcaoEscolhida != 0) {
        alert('A opção escolhida foi a de número ' + opcaoEscolhida)
    }

    opcaoEscolhida = prompt('Escolha uma das opções abaixo: ' +
    '\n 1 - Hambúrguer' +
    '\n 2 - Pizza' +
    '\n 3 - Cachorro-Quente' +
    '\n 4 - Salada' +
    ...
    if(opcaoEscolhida < 1 || opcaoEscolhida > 5){
        alert('O número digitado é inválido. Recarregue a página e tente novamente')
    }
